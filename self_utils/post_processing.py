...
def count_post_processing(np_img,pred,class_names,inference_shape,Tracker,Obj_Counter, track_ids):
    ...
    if pred is not None and len(pred):
        ...
        return np_img, bbox_xyxy, identities, outputs
    if pred is None or len(pred) == 0:
        return np_img, None, None, None
