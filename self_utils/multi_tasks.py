...
def Counting_Processing(input_img,yolo5_config,model,class_names,Tracker,Obj_Counter,track_ids):
    try:
        # 把图片转换成tensor类型
        ...
        # 跟踪计数
        result_img, bboxes, ids, outs=count_post_processing(input_img,pred,class_names,tensor_img.shape,Tracker,Obj_Counter,track_ids)

        return result_img, bboxes, ids, outs
